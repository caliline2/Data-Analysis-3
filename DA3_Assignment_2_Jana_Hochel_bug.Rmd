...
kable(priceperroomOLS, caption='Price per room')
#p1
#p2
#p3
#p4
...
According to OLS, the price per apartment for two starts at 313 dollars for two people. For a fully occupied room of 6 it is 527 dollars. Random Forest Model is a better fit and suggests a smaller difference, 345 dollars for a room for two and 428 for 6 people.

The hotel should analyse a variable cost per guest (bed/energy/toiletries) and fixed cost such as a bathroom to determine the best design in terms of the highest ROI. Should the fixed cost be low, it may be desirable to build smaller apartments for 2 and 3 individuals. Similarly, the visitors in China may prefer smaller apartments as sharing has become less popular due to COVID-19. Thus, this analysis should be repeated after COVID-19 is gone.